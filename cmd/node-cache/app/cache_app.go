...
func (c *CacheApp) initIptables() {
	...
	c.iptablesV4 = newIPTables(utiliptables.ProtocolIPv4)
	c.iptablesV6 = newIPTables(utiliptables.ProtocolIPv6)
}

func newIPTables(protocol utiliptables.Protocol) utiliptables.Interface {
